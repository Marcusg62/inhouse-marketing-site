  ...
  const renderProcess = () => {
    return (
        <div className="container">
            ...
            <h2 className="m-t-20 fs-36">How It Works</h2>
            <hr />
            <h4 className="p-l-16 m-t-8 sans-regular m-r-8 ">
                <p className="fs-22 sans-bold m-t-26"> 1. Menu Upload </p>
                ...
                <p className="fs-22 sans-bold m-t-26"> 2. Business Information </p>
                ...
                <p>We'll audit your online presence and formulate a strategy to strengthen it. We'll look at
                    factors such as: </p>
                <ul className="m-l-16 m-t-8">
                    <li>Current Website</li>
                    <li>Competitors</li>
                    <li>Search Engine Results</li>
                    <li>Yelp & Social Media</li>
                </ul>
                <p className="fs-22 sans-bold m-t-26"> 3. Receive Orders </p>
            ...
            <hr className="" />
            <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question" className="p-l-16 m-t-16">
                <h3 itemprop="name" className="fs-22">How do I get paid? </h3>
            ...
            <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question" className="p-l-16 m-t-16">
                <h3 itemprop="name" className="fs-22">What happens to my domain name? </h3>
                <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                    <div itemprop="text">
            ...
            <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question" className="p-l-16 m-t-16">
                <h3 itemprop="name" className="fs-22">How do I contact support? </h3>
                <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                    <div itemprop="text">
